...
export const footerData = {
  ...
  socialLinks: [
    ...
    { ariaLabel: 'Github', icon: 'tabler:brand-github', href: 'https://github.com/WonderBoxTech' },
  ],
  footNote: `
    ©️ 
    <span class="text-xl logo_header float-left rtl:float-right mr-1 ml-1"></span>
    WonderBox Technologies · All rights reserved.
  `,
};
